...
$.extend( true, DataTable.ext.classes, {
	container: "dt-container dt-bootstrap margin-table",
	search: {
		input: "form-control-donnees2 margin-head-table2 input-sm"
	},
	length: {
		select: "form-control-donnees margin-head-table input-sm"
	},
	processing: {
